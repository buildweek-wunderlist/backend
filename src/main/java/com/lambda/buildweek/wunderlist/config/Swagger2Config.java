...
import springfox.documentation.swagger2.annotations.EnableSwagger2;
    ...
    public class Swagger2Config
    {
        ...
        public Docket api()
        {
            return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                    .basePackage("com.lambda.buildweek.wunderlist"))
        ...
        {
            return new ApiInfoBuilder().title("WunderList 2.0")
                .description("Wunderlist Clone")
                .contact(new Contact("Jamie Sullivan",
